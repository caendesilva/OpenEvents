<x-guest-layout>
    ...
    <!-- Section 1 - Component by Tails -->
    <section class="w-full px-6 pb-12 antialiased bg-white">
        <div class="">
            <nav class="relative z-50 h-24 select-none" x-data="{ showMenu: false }">
                <div
                    class="container relative max-w-full flex flex-wrap items-center justify-between h-24 mx-auto overflow-hidden font-medium border-b border-gray-200 md:overflow-visible lg:justify-center sm:px-4 md:px-2">
                    <div class="flex items-center justify-start w-1/4 h-full pr-4"> <a href="#_"
                            class="inline-block py-4 md:py-0"> <span
                                class="p-1 text-xl font-black leading-none text-gray-900"><span>{{ config('app.name')
                                    }}</span><span class="text-indigo-600">.</span></span> </a> </div>
                    <div class="top-0 left-0 items-start hidden w-full h-full p-4 text-sm bg-gray-900 bg-opacity-50 md:items-center md:w-3/4 lg:text-base md:bg-transparent md:p-0 md:relative md:flex"
                        ...
                        <div
                            class="flex-col w-full h-auto justify-end overflow-hidden bg-white rounded-lg md:bg-transparent md:overflow-visible md:rounded-none md:relative md:flex md:flex-row">
                            <a href="#_"
                                class="inline-flex items-center w-auto h-16 px-6 text-xl font-black leading-none text-gray-900 md:hidden">tails<span
                                    class="text-indigo-600">.</span></a>
                            <div
                                class="flex flex-col items-start justify-end w-full space-x-6 text-center lg:space-x-8 md:w-2/3 md:mt-0 md:flex-row md:items-center">
                                <a href="#_"
                                ...
                                <a href="#_"
                                    class="inline-block w-full py-2 mx-0 font-medium text-left text-gray-700 md:w-auto md:px-0 md:mx-2 hover:text-indigo-600 lg:mx-3 md:text-center">Explore</a>
                                    <a href="#_"
                                    class="inline-block w-full py-2 mx-0 font-medium text-left text-gray-700 md:w-auto md:px-0 md:mx-2 hover:text-indigo-600 lg:mx-3 md:text-center">Dashboard</a>
                               
                                </div>
                            <div
                                class="flex flex-col items-start justify-end w-full pt-4 pl-8 md:items-center md:w-fit md:flex-row md:py-0">
                                <a href="#"
            ...
            <div class="container max-w-lg px-4 py-32 lg:py-40 mx-auto text-left md:max-w-none md:text-center">
                <h1
                    ...
                    <span class="inline md:block">Free Event-Driven</span> <span
                        class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-500 md:inline-block">
                        Analytics Platform</span> </h1>
                <div class="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg"> Fully
                    transparent and open-source analytics. <br> 100% free for personal and open source projects. </div>
                <div class="flex flex-row justify-center items-center mt-12 text-center">
                    <span class="relative inline-flex w-full mx-2 md:w-auto">
                        <a href="#about"
                            class="inline-flex items-center justify-center w-full px-4 py-3 text-base font-bold leading-6 text-indigo-600 border-indigo-600 border border-transparent rounded-full md:w-auto hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
                            Learn More </a>
                    </span>
                    <span class="relative inline-flex w-full mx-2 md:w-auto">
                        <a href="#_"
                            class="inline-flex items-center justify-center w-full px-4 py-3 text-base font-bold leading-6 text-white bg-indigo-600 border border-transparent rounded-full md:w-auto hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
                            Sign Up </a>
                        <a href="#about-pricing"
                            class="absolute top-0 right-0 px-2 py-1 -mt-3 -mr-6 text-xs font-medium leading-tight text-white bg-green-400 rounded-full">It's
                            free*</a>
                    </span>
                </div>
            </div>
    ...
    <section id="about" class="relative py-16 bg-white min-w-screen animation-fade animation-delay">
        <div class="container px-8 mx-auto sm:px-12 xl:px-5">
            ...
            <h3
                class="text-2xl font-bold text-left text-gray-800 sm:text-3xl md:text-4xl lg:text-5xl sm:text-center sm:mx-0 mt-4">
            ...
            <div
                ...
                <h3 class="text-lg font-bold text-purple-500 sm:text-xl md:text-2xl mb-3">
                    How does it work?
                </h3>
                <div class="prose max-w-fit">
                    @markdown
                    OpenEvents is a free, open-source analytics platform that helps you track your events and get
            ...
            <div id="about-pricing"
                ...
                <div class="prose max-w-fit">
                    @markdown
                    My ambition is for this service to be completly free for personal and non-revenue generating open
                    source projects.
