<x-guest-layout>
    ...
    <section id="about" class="relative py-16 bg-white min-w-screen animation-fade animation-delay">
        <div class="container px-8 mx-auto sm:px-12 xl:px-5">
            ...
            <div id="about-beta" class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
                <h3 class="text-lg font-bold text-orange-500 sm:text-xl md:text-2xl mb-3">What is the OpenEvents beta?</h3>
                {!! \App\Core\MarkdownSection::parse('faq/about-the-beta', 'max-w-fit') !!}
            </div>
