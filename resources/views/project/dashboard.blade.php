<x-guest-layout>
	<header class="px-2 md:px-0">
		<div class="container items-center max-w-6xl px-5 mx-auto space-y-6 md:text-center">
			<h1 class="text-4xl font-extrabold tracking-tight text-left text-gray-900 md:text-5xl md:text-center">
	...
	<section class="px-2bg-white md:px-0">
		<div class="container items-center max-w-4xl px-5 mx-auto text-center prose">
			<header class="pb-6">
				<h2 class="my-2">Latest Events:</h2>
			<p>
			...
			<table class="border mt-2 bg-white">
				<thead>
					<tr>
	...
	@if(! (Auth::check() && Auth::user()->is($project->user)))
	<footer>
		<p class="text-center text-lg text-gray-700 mt-6">
			<a href="{{ route('explore') }}">Back to projects</a>
		</p>
	</footer>
	@endif
</x-guest-layout>
